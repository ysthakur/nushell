...
impl Completer for FlagCompletion {
    fn fetch(
        ...
        if let Expr::Call(call) = &self.expression.expr {
            ...
            let mut matcher = NuMatcher::new(String::from_utf8_lossy(&prefix), options, true);
            ...
            for named in &sig.named {
                ...
                if let Some(short) = named.short {
                    ...
                    let named = String::from_utf8_lossy(&named);
                ...
                let named = String::from_utf8_lossy(&named).to_string();
                matcher.add_semantic_suggestion(SemanticSuggestion {
                    suggestion: Suggestion {
                        value: named,
                        description: Some(flag_desc.to_string()),
